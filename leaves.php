...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
          ...
          <table class="table  text-center" style="font-size:10px">
            <thead>
              <tr>
                    ...
                    <th>DVCA</th>
                    <th>VC</th>
                    <!-- <th colspan="3" id="rej_ht" style="display:none;">Message</th> -->
                    <th colspan="3" id="rej_ht">Message</th>
                    <th>Actions</th>
    ...
    <button id="opppe" class="btn btn-danger" data-toggle='modal' data-target='#newRequestModal' style="display:none;">open</button>
    <!-- New Request Modal-->
      ...
      <div class="modal-dialog" style="min-width: 80%" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" style="margin:0 auto" id="exampleModalLabel">Leave Rejection Reason</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="false">×</span>
            </button>
          </div>
          <input type="hidden" name="" id="LeaveRequested">
          <input type="hidden" name="" id="TypeOfApprover" value="2">
            <div class="modal-body">
              <div class="row form-group">
                <div class="col-12">
                  <p class="help-block text-danger" id="ress"></p>
                  <label style="font-weight: bold;" for="dateFrom">Rejection Reason:</label>
                  <input type="text" id="rejectReason" class="form-control" placeholder="Write your comment here ...">
                </div>
              </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
              <button class="btn btn-primary" type="button" onclick="return RejectLeave();" id="save" name="save">Reject</button>
            </div>
        </div>
      </div>
    </div>
          ...
          $.ajax({url:"main/view.php",
            type:"POST",data:{AllAvailableLeavesApproved:AllAvailableLeavesApproved},cache:false,success:function(res){  
              ...
              if (res.found===1) {
                ...
                for (const key in res.res) {
                  console.log(key);
                  $("#respp").append("<tr>  <td> * </td>  <td>"+res.res[key].Names+"</td>  <td>"+res.res[key].Post+"</td>  <td>"+res.res[key].LeaveDate+"</td>  <td>"+res.res[key].LeaveFrom+"</td>  <td>"+res.res[key].LeaveTo+"</td>  <td>"+res.res[key].LeaveDays+"</td>  <td style='background-color:#d1cec7'>"+res.res[key].allowed+"</td> <td>"+res.res[key].LeaveRemainig+"</td> <td>"+res.res[key].Reason+"</td><td>"+res.res[key].StatusSupervisor+"</td> <td>"+res.res[key].StatusHR+"</td> <td>"+res.res[key].StatusDVCPAF+"</td> <td>"+res.res[key].StatusDVCA+"</td> <td>"+res.res[key].StatusVC+"</td> <td colspan=3><b>"+res.res[key].RejectionReason+"</b></td>  <td> <button onclick='return PendingLeave(2,"+res.res[key].LeaveId+")' class='btn btn-primary'>Pending</button> <button onclick='return RejectModal(2,"+res.res[key].LeaveId+")' class='btn btn-danger'>Reject</button></td> </tr>");
                }
              }else{
                $("#respp").html("<tr><td colspan='10'>No Leave requested yet... </td>  </tr>");
              }
          ...
          $.ajax({url:"main/view.php",
            type:"POST",data:{AllAvailableLeavesRejected:AllAvailableLeavesRejected},cache:false,success:function(res){  
              ...
              if (res.found===1) {
                ...
                for (const key in res.res) {
                  console.log(key);
                  $("#respp").append("<tr>  <td> * </td>  <td>"+res.res[key].Names+"</td>  <td>"+res.res[key].Post+"</td>  <td>"+res.res[key].LeaveDate+"</td>  <td>"+res.res[key].LeaveFrom+"</td>  <td>"+res.res[key].LeaveTo+"</td>  <td>"+res.res[key].LeaveDays+"</td>  <td style='background-color:#d1cec7'>"+res.res[key].allowed+"</td> <td>"+res.res[key].LeaveRemainig+"</td>  <td>"+res.res[key].Reason+"</td> <td>"+res.res[key].StatusSupervisor+"</td> <td>"+res.res[key].StatusHR+"</td> <td>"+res.res[key].StatusDVCPAF+"</td> <td>"+res.res[key].StatusDVCA+"</td> <td>"+res.res[key].StatusVC+"</td> <td colspan=3><b>"+res.res[key].RejectionReason+"</b></td>  <td> <button onclick='return ApproveLeave(2,"+res.res[key].LeaveId+")' class='btn btn-success'>Approve</button> <button onclick='return PendingLeave(2,"+res.res[key].LeaveId+")' class='btn btn-default'>Pending</button></td> </tr>");
                }
              }else{
                $("#respp").html("<tr><td colspan='10'>No Leave requested yet... </td>  </tr>");
              }
          ...
          $.ajax({url:"main/view.php",
            type:"POST",data:{AllAvailableLeavesPending:AllAvailableLeavesPending},cache:false,success:function(res){  
              ...
              if (res.found===1) {
                ...
                for (const key in res.res) {
                  console.log(key);
                  $("#respp").append("<tr>  <td> * </td>  <td>"+res.res[key].Names+"</td>  <td>"+res.res[key].Post+"</td>  <td>"+res.res[key].LeaveDate+"</td>  <td>"+res.res[key].LeaveFrom+"</td>  <td>"+res.res[key].LeaveTo+"</td>  <td>"+res.res[key].LeaveDays+"</td>  <td style='background-color:#d1cec7'>"+res.res[key].allowed+"</td> <td>"+res.res[key].LeaveRemainig+"</td>  <td>"+res.res[key].Reason+"</td><td>"+res.res[key].StatusSupervisor+"</td> <td>"+res.res[key].StatusHR+"</td> <td>"+res.res[key].StatusDVCPAF+"</td> <td>"+res.res[key].StatusDVCA+"</td> <td>"+res.res[key].StatusVC+"</td>  <td colspan=3><b>"+res.res[key].RejectionReason+"</b></td>  <td> <button onclick='return PendingLeave(2,"+res.res[key].LeaveId+")' class='btn btn-success'>Approve</button> <button onclick='return RejectModal(2,"+res.res[key].LeaveId+")' class='btn btn-danger'>Reject</button></td> </tr>");
                }
              }else{
                $("#respp").html("<tr><td colspan='10'>No Leave requested yet... </td>  </tr>");
              }
