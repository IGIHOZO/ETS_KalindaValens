...
if (@$_SESSION['utb_att_position']!='DVCA' AND @$_SESSION['utb_att_position']!='DVCPAF') {
  ?>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-control" id="descendents">
                    <?php 
                    $sel = $con->prepare("SELECT * FROM users WHERE users.Position IN('supervisor')");
                    $sel->execute();
                    if ($sel->rowCount()>=1) {
                      while ($ft_sel = $sel->fetch(PDO::FETCH_ASSOC)) {
  ...
  $(document).ready(function(){
     var MineDVCsOrientedGoals = true;

      $.ajax({url:"main/view.php",
        type:"POST",data:{MineDVCsOrientedGoals:MineDVCsOrientedGoals},cache:false,success:function(res){  
