...
<script type="text/javascript">
  ...
  if (@$_SESSION['utb_att_position']=='VC') {
    $toShow = "EmployeeGoals";
  }else if (@$_SESSION['utb_att_position']=='Employee') {
    $toShow = "Employee";
  }else{
    $toShow = '-';
  }
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="imihigo_employee">My Goals</a>
            </li>
            <li>
              <a href="achievements_employee">Achievements</a>
            </li>
          </ul>
        </li>
      </ul>
...
<script>
  ...
  $(document).ready(function(){
     var EmployeeGoals = 'EmployeeGoals';
      ...
      if (toShow=='DVCsGoals') {
        ...
        EmployeeGoals = 'DVCsGoals';
        $(".btn btn-primary").css("display","block");

      }else if(toShow=='EmployeeGoals'){
        diapl = "none";
        diaplInvs = "block";
        // $("#th_btns").css("display","none");
        $("#newGoalBtn").css("display","none");
      ...
      $.ajax({url:"main/view.php",
        type:"POST",data:{EmployeeGoals:EmployeeGoals},cache:false,success:function(res){  
          ...
          if (res.found===1) {
            ...
            for (const key in res.res) {
              ...
              $("#respp").append("<tr>  <td> "+ i +" </td>  <td>"+res.res[key].ImihigoName+"</td>  <td>"+res.res[key].ImihigoDetails+"</td> <td>"+res.res[key].MyGoals+"</td> <td>"+res.res[key].ImihigoDate+"</td>    <td>"+res.res[key].ImihigoStatus+"</td> <td> <button class='btn btn-primary' onclick='return SetGoalModal("+res.res[key].ImihigoId+","+res.res[key].ImihigoId+")' data-toggle='modal' id='newGoalBtn' data-target='#OrientUmuhigoModal'>Set Goal</button></td> </tr>");
                i++;
