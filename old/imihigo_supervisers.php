...
<script>
  ...
  $(document).ready(function(){
     var SupervisorGoals = 'SupervisorGoals';
      ...
      if (toShow=='DVCsGoals') {
        ...
        SupervisorGoals = 'DVCsGoals';
        $(".btn btn-primary").css("display","block");

      }else if(toShow=='SupervisorGoals'){
        diapl = "none";
        diaplInvs = "block";
        // $("#th_btns").css("display","none");
        $("#newGoalBtn").css("display","none");
        SupervisorGoals = 'SupervisorGoals';
        $(".btn btn-primary").css("display","block");
      }
      else{
        diapl = "block";
      ...
      $.ajax({url:"main/view.php",
        type:"POST",data:{SupervisorGoals:SupervisorGoals},cache:false,success:function(res){  
