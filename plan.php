      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="imihigo_employee.php">My Goals</a>
            </li>
            <li>
              <a href="achievements_employee.php">Achievements</a>
            </li>
          </ul>
        </li>
      </ul>
...
// $("#newReq").click(); //===================== Minimizing Menu Section
  ...
  $('input[name="daterange"]').html="Your range here";
      ...
      var MyLeaveRange = true;
      $.ajax({url:"main/view.php",
        type:"POST",data:{MyLeaveRange:MyLeaveRange},cache:false,success:function(res){  
          ...
          if (res.found===1) {
            ...
            for (const key in res.res) {
              // console.log(key);
              var i = key;
              $("#respp").append("<tr>  <td> "+ ++i+" </td>  <td>"+res.res[key].RangeDate+"</td>  <td style='text-align:left'> "+res.res[key].RangeDetails+" </td> </tr>");
            }
          }else{
